...
namespace Admin.NET.Database.Migrations.Migrations
{
    ...
    [Migration("20211029025212_add--project-comment")]
    partial class addprojectcomment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Admin.NET.Application.Customer", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("Admin.NET.Application.Project", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasComment("Id主键");
                    ...
                    b.Property<long>("CustomerMineId")
                        .HasColumnType("bigint")
                        .HasComment("客户煤矿编号");
                    ...
                    b.Property<DateTimeOffset?>("ProjectDate")
                        .HasColumnType("timestamp with time zone")
                        .HasComment("立项日期");
            ...
            modelBuilder.Entity("Admin.NET.Application.Project", b =>
                {
                    b.HasOne("Admin.NET.Application.Customer", "CustomerGroup")
                        .WithMany()
                        .HasForeignKey("CustomerGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Admin.NET.Application.Customer", "CustomerMine")
                        .WithMany()
                        .HasForeignKey("CustomerMineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CustomerGroup");

                    b.Navigation("CustomerMine");
                });
